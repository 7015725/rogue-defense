...
- Level Up 完全暂停；
- 三选一、Skip → Credits、Reroll Charge；
- Slot 1 固定 Auto Cannon + 4 个随机武器槽；
- 五种随机武器池：LMG、Shotgun、Sniper、Auto-GL、Tesla；
- 所有 6 把武器可独立 Lv1～10；
- Lv5 α / β / γ 路线 + Lv10 路线专精；
- Armor / Heavy / GroundPath / AirPath / TargetDomain；
- Recon Drone 与防空随机保护；
- 统一 StatusEffectSystem：Burn / Slow / Freeze / Stun / ArmorBreak / Charged / Suppressed；
- 首批 4 个 Combo：爆燃协议 / 震荡破甲 / 电力过载 / 控制处决；
- Boss Shop：固定 5 格、后勤位、购买、SOLD、指数刷新；
- Base Heal / Weapon Repair / Global Stat / Weapon Level / New Weapon / Combo / Reroll Charge 商品；
- 武器耐久：HP / Disabled / AutoRepair / Shop Repair；
- 满槽武器替换与 Wave 等级补偿；
- Wave 21～29 常规波开始混入 Flying；
- 1× / 2× / 3× / 4× 模拟速度。
...
升级、武器路线、Boss Shop 与替换界面使用鼠标或触摸点击。

## 文档

- [设计文档索引](docs/README.md)
- [M0.8 设计](docs/m0.8-design.md)
- [M0.8 验证清单](docs/m0.8-validation.md)
